# -*- coding: utf-8 -*-
"""
Created on Fri Nov 23 09:31:37 2018
...
app.config['MYSQL_DATABASE_PASSWORD'] = 'ching123'
app.config['MYSQL_DATABASE_DB'] = 'company_exercise'
...
def submit():
    try:
        ...
        if _cus_code and _cus_lname and _cus_fname and _cus_initial and _cus_areacode and _cus_phone and _cus_balance:
            ...
            if len(data) is 0:
                conn.commit()
#                return json.dumps({'message':'User created successfully ! </p> <a href=http://127.0.0.1:5003/> Back to Home </a></p>'}
                txtValue = request.form['cus_fname']
                print("received:" + txtValue);
                return render_template('CustomerSubmitForm.html',inputName=txtValue)    
            else:
